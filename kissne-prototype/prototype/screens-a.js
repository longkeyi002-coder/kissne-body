  ...
  K.registerScreen({
    ...
    mount: function (root, ctx) {
      ...
      function applyLiveEvent(event) {
        ...
        /* Transport/runtime failures are objective behavior states. They do not become
           a completed message emotion and therefore never overwrite prior message snapshots. */
