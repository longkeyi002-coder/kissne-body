...
(function () {
    ...
    render: function () {
      ...
      <div class="screen">
        ...
        <div class="screen__body">
          ${card(
            '<div class="acct">'
            + ph('FOX_NOTIFICATION_AVATAR', { size: 44, compact: true, tag: '头像', round: true })
  ...
  K.registerScreen({
    ...
    render: function () {
      var foxNotify = ph('FOX_NOTIFICATION_AVATAR', { size: 40, compact: true, tag: '头像', round: true });
      return `
      <div class="screen">
      ...
      <div class="screen">
        ...
        <div class="screen__body">
          ${banner({ icon: 'box', title: '替换方式',
            body: '正式素材完成后，按 data-placeholder 代码替换占位内容，页面结构不变。' })}
