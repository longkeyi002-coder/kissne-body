...
class TurnRunner:
    ...
    def _wire_turn_agent_callbacks(self, agent, turn_route, reasoning_config,
        ...
        # Provider-visible reasoning is already a first-class Agent callback.  Keep it
        # off the assistant text stream and hand it only to adapters that explicitly
        # expose a separate reasoning lane (currently Kissne Mobile).
